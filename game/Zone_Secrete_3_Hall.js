class Hall extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('tilemap3', 'assets/maps/ZL_ZONE_SECRETE_3.json')
    ...
    create() {
        ...
        this.enemy = this.physics.add.sprite(31 * 16, 58 * 16, 'enemy').setSize(18,23).setOffset(11,8);
    ...
    changeScene() {
        this.scene.start("monjeu", { x: 296 * 16, y: 80 * 16 })
